...
from ugeeapp.models import StopEvent,UserRoles,MyQualification,Trainings,StopCode,ReasonOne,ReasonTwo,ReasonTri,ReasonFour,Equipment,User,Production
import time
import json
import os
import datetime
...
class AdminRoles():
	...
	def get_user_roles(self,userid=1):
	...
	def add_user_role(self,form):
		...
		new = UserRoles()
		new.rname = form.name.data.title()
	...
	def delete_admin_role(self,roleid):
		...
		if roleid in self.get_user_roles():
